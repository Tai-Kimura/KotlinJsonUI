...
data class InputAttributes(
    ...
    companion object {
         ...
         */
        fun parse(json: Map<String, Any?>, canonicalOnly: Boolean = false): InputAttributes = InputAttributes(
        ...
        private fun parseAutocapitalizationType(raw: Any?): AttrEnum<AutocapitalizationType>? {
            ...
            AttrWarnings.emit("Input.autocapitalizationType: unknown enum value '$raw'")
        ...
        private fun parseAutocorrectionType(raw: Any?): AttrEnum<AutocorrectionType>? {
            ...
            AttrWarnings.emit("Input.autocorrectionType: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
        ...
        private fun parseBorderStyle(raw: Any?): AttrEnum<BorderStyle>? {
            ...
            AttrWarnings.emit("Input.borderStyle: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
        ...
        private fun parseContentType(raw: Any?): AttrEnum<ContentType>? {
            ...
            AttrWarnings.emit("Input.contentType: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
        ...
        private fun parseInput(raw: Any?): AttrEnum<Input>? {
            ...
            AttrWarnings.emit("Input.input: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
        ...
        private fun parseInputType(raw: Any?): AttrEnum<InputType>? {
            ...
            AttrWarnings.emit("Input.inputType: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
        ...
        private fun parseReturnKeyType(raw: Any?): AttrEnum<ReturnKeyType>? {
            ...
            AttrWarnings.emit("Input.returnKeyType: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
        ...
        private fun parseTextAlign(raw: Any?): AttrEnum<TextAlign>? {
            ...
            AttrWarnings.emit("Input.textAlign: unknown enum value '$raw'")
            return AttrEnum.Unknown(raw)
        }
    }
}
