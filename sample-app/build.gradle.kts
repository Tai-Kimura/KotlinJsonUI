...
android {
    ...
    buildFeatures {
        ...
        dataBinding = true
        viewBinding = true
        // AGP 9: resValues defaults to off (android.defaults.buildfeatures.resvalues was
        // removed). The debug/release resValue("string", "app_name_suffix", ...) calls
        // below need it enabled per-module.
        resValues = true
    }
...
dependencies {
    ...
    // Conditionally include dynamic module only in debug builds
    debugImplementation(project(":library-dynamic"))
