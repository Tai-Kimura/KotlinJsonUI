...
fun TextDecorationTestGeneratedView(
    ...
    Box(propagateMinConstraints = true) {
        ...
        if (DynamicModeManager.isActive()) {
            ...
            Column(
                ...
                PartialAttributesText(
                    ...
                    linkable = true,
                    style = LocalTextStyle.current.copy(color = colorResource(R.color.black), fontFamily = (resolved_text2.family ?: LocalTextStyle.current.fontFamily), fontWeight = (resolved_text2.weight ?: LocalTextStyle.current.fontWeight), fontSize = (resolved_text2.size ?: LocalTextStyle.current.fontSize), fontStyle = (resolved_text2.style ?: LocalTextStyle.current.fontStyle)),
                    modifier = Modifier
                )
                ...
                PartialAttributesText(
                    ...
                    linkable = true,
                    style = LocalTextStyle.current.copy(color = colorResource(R.color.black), fontFamily = (resolved_text3.family ?: LocalTextStyle.current.fontFamily), fontWeight = (resolved_text3.weight ?: LocalTextStyle.current.fontWeight), fontSize = (resolved_text3.size ?: LocalTextStyle.current.fontSize), fontStyle = (resolved_text3.style ?: LocalTextStyle.current.fontStyle)),
                    modifier = Modifier
                )
                ...
                PartialAttributesText(
                    ...
                    linkable = true,
                    style = LocalTextStyle.current.copy(color = colorResource(R.color.dark_blue), fontFamily = (resolved_text4.family ?: LocalTextStyle.current.fontFamily), fontWeight = (resolved_text4.weight ?: LocalTextStyle.current.fontWeight), fontSize = (resolved_text4.size ?: LocalTextStyle.current.fontSize), fontStyle = (resolved_text4.style ?: LocalTextStyle.current.fontStyle)),
                    modifier = Modifier
                )
                ...
                PartialAttributesText(
                    ...
                    linkable = true,
                    style = LocalTextStyle.current.copy(color = colorResource(R.color.white), fontFamily = (resolved_text5.family ?: LocalTextStyle.current.fontFamily), fontWeight = (resolved_text5.weight ?: LocalTextStyle.current.fontWeight), fontSize = (resolved_text5.size ?: LocalTextStyle.current.fontSize), fontStyle = (resolved_text5.style ?: LocalTextStyle.current.fontStyle)),
                    modifier = Modifier
        ...
        ScreenMarker("text_decoration_test")
    }
    // >>> GENERATED_CODE_END
}